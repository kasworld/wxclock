...
class kclock(wx.Frame):
    ...
    def _drawCalendar(self,dc):
        ...
        self._printText( dc,datetext,self.mcenterx/5 , self.adj*2) 
            ...
            for wwx in wwl :
                ...
                if ( wwx[0] ) :
                    ...
                    self._printText( dc, str(wwx[0]) ,
                        self.adj/2+ posx * self.adj * .75  ,
                        self.clientsize[1] - self.adj*4.5 + wwy *self.adj*.75,
                        *ccc  )
                posx += 1
            wwy += 1
    ...
    def _OnPaint(self, evt):
        ...
        self._printText( dc,datetext,self.mcenterx/5 , 0) 
        self._drawHands( dc )
